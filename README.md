...
> Multi-platform VAG CAN-Bus telemetry, diagnostics, touchscreen instrumentation and real-time web dashboard for ESP32-P4.

---

## 🚗 Overview

CAN Decoder is an ESP32-P4 based telemetry platform designed to decode, interpret and visualise vehicle data from multiple Volkswagen Audi Group (VAG) network generations.
...
- 🧪 Built-in vehicle simulation

All running directly on embedded hardware without requiring an external server.
